...
//     const handleSave = () => {
//         navigate(`/Kanbas/Courses/${courseId}/Assignments/`, { state: { newAssignment } });
//     };
...
//                             rows={4} placeholder="Enter Assignment Description"
...
//                                         <input type="date" className="form-control" placeholder="" id="dueDate" value={assignment?.dueDate}
...
//                                                     id="availableFrom" value={assignment?.availableFromDate}
//                                                     onChange={(e) => setNewAssignment({ ...newAssignment, availableFromDate: e.target.value })} />
//                                             </div>
//                                         </div>
//                                         <div className="col">
//                                             <div className="mb-3">
//                                                 <input type="date" className="form-control" placeholder=""
//                                                     id="until" value={assignment?.availableUntilDate}
